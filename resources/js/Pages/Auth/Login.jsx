                            ...
                            <form onSubmit={submit}>
                                ...
                                <div className="mb-6">
                                    <div className="flex items-center">
                                        ...
                                        />
                                        <label htmlFor='remmbr' className="ms-2 text-gray-600">Remember me</label>
                                    </div>
                                </div>
                                ...
                                <div className="mb-5">
                                    <div className="flex  flex-col md:flex-row md:items-center justify-between mt-4 gap-6">
                                        ...
                                        <button
                                            disabled={processing}
                                            type="submit"
                                            className="text-xl font-semibold cursor-pointer rounded-lg border p-2 px-4 transition hover:bg-opacity-90"
                                        >
                                            Sign In
                                        </button>
                                    </div>
